...
namespace CadastroEscola.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdAluno,Nome,Sobrenome,CPF,Nascimento,Nota,MediaFinal")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAluno,Nome,Sobrenome,CPF,Nascimento,Nota,MediaFinal")] Aluno aluno)
        {
            if (id != aluno.IdAluno)
            {
                return NotFound();
